...
.url:hover
{
  ...
  <body>
	<div id="content">
	  	<h2>XML Sitemap</h2>
		<p class="expl">Generated by <a href="https://nvidiavn.vn/" target="_blank" title="Sitemap generator for Laravel">Nvidiavn.vn</a>. This is styled xml sitemap, sorted by update date.</p>
		...
		<tbody>
	      ...
	      <tr>
	        <td class="url"><xsl:apply-templates select="s:loc"/></td>
