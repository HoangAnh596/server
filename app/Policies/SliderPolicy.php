...
class SliderPolicy
{
    ...
    {
        return $user->checkPermissionAccess(config('permissions.access.checkbox-slider'));
    }

    public function checkStt(User $user)
    {
        return $user->checkPermissionAccess(config('permissions.access.checkStt-slider'));
    }
}
