...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <form id="slidersForm" action="{{ route('sliders.update', $slider->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            @if (!empty($slider))
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $slider->name ?? '') }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="form-group">
                                    <input type="text" name="url_text" id="name" class="form-control" value="{{ old('url_text', $slider->url_text ?? '') }}">
                                </div>
                            </div>
                            <div class="d-flex align-items-center" style="height: 38px; color: red;"><i class="fa-solid fa-circle-info"></i></div>
                        </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-2">
                        <div class="input-group">
                            <input id="thumbnail" class="form-control" type="hidden" name="filepath" value="{{ old('image', $slider->image ?? '') }}">
                        ...
                        <div id="holder">
                            <img id="out_img" src="{{ \App\Http\Helpers\Helper::getPath($slider->image) }}">
                        </div>
                    </div>
                ...
                <div class="row mt-3 mb-3">
                    ...
                    <div class="col-2 d-flex align-items-center">
                        <select class="form-control" aria-label="Default" name="is_public">
                            ...
                            <option value="1"
                                @if(!empty($slider) && $slider->is_public == 1) selected @endif> Hiển thị
                            </option>
                        </select>
                    </div>
                    <div class="d-flex align-items-center" style="height: 38px; color: red;"><i class="fa-solid fa-circle-info"></i></div>
