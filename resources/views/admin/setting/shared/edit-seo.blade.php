<div class="text-dark">
    ...
    <div class="row">
        ...
        <div class="col-8 d-flex align-items-center pb-3">
            <input type="text" name="keyword_seo" class="form-control" value="{{ old('keyword_seo', $setting->keyword_seo ?? '') }}">
        </div>
        <div class="d-flex align-items-center" style="height: 38px; color: red;"><i class="fa-solid fa-circle-info"></i></div>
    </div>
    <div class="row">
        ...
        <div class="col-8">
            <textarea name="des_seo" class="form-control" id="des_seo" rows="5" onkeyup="delayedValidate('des_seo', 'desSeoWarning', 150, 160)">{{ old('des_seo', $setting->des_seo ?? '') }}</textarea>
