        ...
        <form id="groupsForm" action="{{ route('groups.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="text-dark card-body border-top">
                ...
                <div class="row mt-3 mb-3">
                    ...
                    <div class="col-1">
                        <input type="number" class="form-control" style="width:80px" name="max_quantity" value="{{ old('max_quantity')}}">
                    </div>
                    <div class="d-flex align-items-center" style="height: 38px; color: red;"><i class="fa-solid fa-circle-info"></i></div>
                </div>
                <div class="row mt-3 mb-3">
                    ...
                    <div class="col-1">
                        <input type="number" class="form-control" style="width:80px" name="stt" value="{{ old('stt')}}">
                    </div>
                    <div class="d-flex align-items-center" style="height: 38px; color: red;"><i class="fa-solid fa-circle-info"></i></div>
                </div>
            </div>
