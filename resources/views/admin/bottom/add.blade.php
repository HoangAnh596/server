...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <form id="bottomsForm" action="{{ route('bottoms.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('POST')
            ...
            <div class="text-dark card-body border-top">
                ...
                <div class="row">
                    <div class="col-2 d-flex flex-row-reverse align-items-center" style="height: 38px;">Link đường dẫn :<div class="warningMenu">*</div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
