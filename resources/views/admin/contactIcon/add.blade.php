...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between">
        <h3 class="mb-2 text-gray-800">Thêm mới thông tin icon liên hệ</h3>
        <h6 aria-label="breadcrumb">
            <ol class="breadcrumb bg-light">
                <li class="breadcrumb-item"><a href="javascript: void(0);">Icon liên hệ</a></li>
    ...
    <div class="card shadow">
        <form id="iconsForm" action="{{ route('contact-icons.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('POST')
